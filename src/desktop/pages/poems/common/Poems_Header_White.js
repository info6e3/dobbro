    ...
    return (
        <div>
            <footer className={"PoemsFooter"}>
                ...
                <h1 className={"PoemsFooterTitle"}><a className={"White_PoemsFooterTitle_Link"} href={config.address}>dobbro</a></h1>


                <div className={"PoemsFooterMenu unselectable"} onClick={()=>MenuOpen()}>
                    <div id={'PoemsFooterMenu_LineTop'} className={"White_PoemsFooterMenu_Line"}></div>
                    <div id={'PoemsFooterMenu_LineCenter'} className={"White_PoemsFooterMenu_Line"}></div>
                    <div id={'PoemsFooterMenu_LineBot'} className={"White_PoemsFooterMenu_Line"}></div>
                </div>

                <div className={"PoemsFooter_LinksContainer_VisibleArea"}>
                    <div className={"White_PoemsFooter_GradientPanel"}></div>
                    <div className={"PoemsFooter_LinksContainer"}>
                        <a className={"White_PoemsFooter_Link"} href={`${config.address}content`} id={"PoemsFooter_LinkTop"}>оглавление</a>
                        <a className={"White_PoemsFooter_Link"} href={config.download} id={"PoemsFooter_LinkCenter"}>скачать</a>
                        <a className={"White_PoemsFooter_Link"} href={`${config.address}about`} id={"PoemsFooter_LinkBot"}>контакты</a>
                    </div>
                </div>
            </footer>
            <div className={"PoemsHeader_Space"}></div>
        </div>
    );
}

export default Poems_Footer;
